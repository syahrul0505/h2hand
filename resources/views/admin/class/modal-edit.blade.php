<div class="modal fade modal-notification" id="tabs-{{ $class->id }}-edit-class" tabindex="-1" role="dialog"
    aria-labelledby="tabsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('class.update', $class->id) }}" method="post" class="modal-content">
            @csrf
            @method('PUT')
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm"
                                placeholder="Ex: Kelas Reguler Pagi" id="name"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="type" class="form-control form-control-sm"
                                placeholder="Ex: Reguler" id="type" value="{{ $class->type ?? old('type') }}">
                            @if($errors->has('type'))
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="grade" class="form-control form-control-sm" placeholder="Ex: U-12"
                                id="grade" value="{{ $class->grade ?? old('grade') }}">
                            @if($errors->has('grade'))
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="registration_fee" class="form-control form-control-sm"
                                placeholder="0" id="registration_fee"
                                value="{{ $class->registration_fee ?? old('registration_fee') }}" step="any">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="regular_contribution_price" class="form-control form-control-sm"
                                ...
                                value="{{ $class->regular_contribution_price ?? old('regular_contribution_price') }}"
                                step="any">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="quota_package_price" class="form-control form-control-sm"
                                placeholder="0" id="quota_package_price"
                                value="{{ $class->quota_package_price ?? old('quota_package_price') }}" step="any">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="number_of_attendance" class="form-control form-control-sm"
                                placeholder="0" id="number_of_attendance"
                                value="{{ $class->number_of_attendance ?? old('number_of_attendance') }}">
