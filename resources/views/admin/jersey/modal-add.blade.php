<div class="modal fade modal-notification" id="tabs-add-jersey" tabindex="-1" role="dialog"
    aria-labelledby="tabsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('jerseys.store') }}" method="post" class="modal-content" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="size" class="form-control form-control-sm"
                                placeholder="Ex: L, XL, S" id="size" value="{{ old('size') }}">
                            @if($errors->has('size'))
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form-control-sm" name="show_on_registration_form"
                                ...
                                <option value="1" {{ old('show_on_registration_form') == 1 ? 'selected' : '' }}>Ya
                                </option>
                                <option value="0" {{ old('show_on_registration_form') == 0 ? 'selected' : '' }}>Tidak
                                </option>
                            </select>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form-control-sm" name="back_number" id="back_number">
                                <option value="1" {{ old('back_number') == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ old('back_number') == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form-control-sm" name="back_name" id="back_name">
                                <option value="1" {{ old('back_name') == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ old('back_name') == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
