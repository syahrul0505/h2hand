...
class ExpensesController extends Controller
{
    ...
    public function store(AddExpensesRequest $request)
    {
        ...
        try {
            ...
            $expenses->amount        = $dataExpenses['amount'];
            ...
            \Log::error('Failed to create expense: ' . $th->getMessage());
            $request->session()->flash('failed', "Failed to create data Expenses: " . $th->getMessage());
            return redirect(route('expenses.index'));
        }
    }
    ...
    public function update(UpdateExpensesRequest $request, $expensesId)
    {
        ...
        try {
            ...
            \Log::error('Failed to update expense: ' . $th->getMessage());
            $request->session()->flash('failed', "Failed to update data Expenses: " . $th->getMessage());
            return redirect(route('expenses.index'));
        }
    }
